...
pacman -Syu --needed inetutils stow cmake nodejs-lts-jod npm python-pip fd ripgrep fzf luarocks tldr man-pages tmux neovim lazygit diff-so-fancy nnn btop foot-terminfo
pacman -Scc
mandb
