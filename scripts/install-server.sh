...
pacman -Syu --needed bc inetutils stow imagemagick cmake ninja meson nodejs-lts-jod npm python-pip fd ripgrep fzf luarocks tldr man-pages tmux neovim lazygit diff-so-fancy nnn btop foot-terminfo
pacman -Scc
mandb
