...
sudo pacman -Syu --needed bc inetutils stow imagemagick cmake ninja meson git nodejs-lts-jod npm python-pip ripgrep fzf fd luarocks tldr man-db man-pages tmux neovim lazygit nnn btop zip unzip wl-clipboard speech-dispatcher power-profiles-daemon python-gobject playerctl bluez bluez-utils bluetui impala fprintd iptables-nft ufw fwupd udisks2 noto-fonts-cjk noto-fonts-extra noto-fonts-emoji ttf-sourcecodepro-nerd xdg-desktop-portal-gtk xdg-desktop-portal-wlr polkit-gnome bemenu bemenu-wayland j4-dmenu-desktop cliphist dunst libnotify rtkit mpv imv zathura zathura-pdf-mupdf tesseract-data-eng fcitx5 fcitx5-configtool fcitx5-qt fcitx5-chinese-addons libreoffice-fresh
sudo pacman -Scc
sudo mandb
