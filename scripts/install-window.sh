...
sudo pacman -Syu --needed bc inetutils stow imagemagick cmake ninja meson git nodejs-lts-jod npm python-pip fd ripgrep fzf luarocks tldr man-db man-pages tmux neovim lazygit diff-so-fancy nnn btop zip unzip wl-clipboard speech-dispatcher playerctl power-profiles-daemon python-gobject bluez bluez-utils bluetui impala fprintd iptables-nft ufw fwupd udisks2 noto-fonts-cjk noto-fonts-extra noto-fonts-emoji ttf-sourcecodepro-nerd xdg-desktop-portal-gtk xdg-desktop-portal-wlr polkit-gnome bemenu bemenu-wayland j4-dmenu-desktop cliphist dunst libnotify rtkit mpv wf-recorder imv zathura zathura-pdf-mupdf tesseract-data-eng fcitx5 fcitx5-configtool fcitx5-qt fcitx5-chinese-addons libreoffice-fresh
