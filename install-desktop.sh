...
sudo pacman -Syu --needed cmake ninja neovim nodejs-lts-jod npm python-pip fd luarocks wl-clipboard speech-dispatcher tldr fprintd power-profiles-daemon python-gobject lazygit btop ufw fwupd noto-fonts-cjk noto-fonts-extra ttf-sourcecodepro-nerd man-db man-pages haruna gwenview okular filelight isoimagewriter kitty fcitx5 fcitx5-configtool fcitx5-qt fcitx5-chinese-addons libreoffice-fresh
sudo pacman -Scc
sudo mandb
