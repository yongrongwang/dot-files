...
static char *fonts[]          = { "NotoSans:size=11", "NotoColorEmoji:pixelsize=11:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY,			            XK_r,          spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "lazygit", NULL } } },
	...
	{ MODKEY|ShiftMask,	            XK_n,          spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "impala", NULL } } },
	...
	{ ShiftMask,		            XK_Print,      spawn,                  SHCMD("maim -u -s pic-full-$(date '+%y%m%d-%H%M-%S').png") },
