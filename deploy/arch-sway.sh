...
sudo pacman -Syu --needed qutebrowser bluetui impala nnn noto-fonts-extra noto-fonts-cjk noto-fonts-emoji adobe-source-code-pro-fonts mpv zathura zathura-pdf-mupdf dunst libnotify rtkit tesseract-data-eng bemenu bemenu-wayland j4-dmenu-desktop imv wf-recorder wl-clipboard cliphist polkit-gnome xdg-desktop-portal-gtk xdg-desktop-portal-wlr
